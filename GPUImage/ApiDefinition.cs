...
*/		
    ...
    public interface GPUImageiOSBlurFilter
    {
      [Export("blurRadiusInPixels")]
      float BlurRadiusInPixels { get; set; }
      ...
      float RangeReductionFactor { get; set; }
    }

    [BaseType(typeof(GPUImageFilter))]
    public interface GPUImageLuminanceRangeFilter
    {
      [Export("rangeReductionFactor")]
      float RangeReductionFactor { get; set; }
    }
    ...
    public interface GPUImageGaussianBlurFilter
    {
      [Export("blurRadiusInPixels")]
      float BlurRadiusInPixels { get; set; }
    }
